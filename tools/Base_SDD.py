...
TABLA_DOCUMENTOS = "documents_langchain_sdd"
...
# ============================================
@tool
def buscar_sdd(consulta: str) -> str:
    """
    Busca información sobre SDD en la base de conocimientos.
    Usa esta herramienta cuando el usuario pregunte sobre:
    - Programas de SDD
    - Cualquier información relacionada con SDD
